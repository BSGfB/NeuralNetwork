...
namespace NeuralNetwork {
    namespace Layer { 
		...
		unsigned int ExecutLayer::getInputSize() {
                ...
                ActivationFunction::AbstractActivationFunction* ExecutLayer::getActivationFunction() const {
                    return activationFunction;
                }
                
                void ExecutLayer::setActivationFunction(ActivationFunction::AbstractActivationFunction* activationFunction) {
